...
// Delclare htmlCode variable with an empty text string
let htmlCode = ""

// Create for loop to loop through the captions array and add the corresponding image and caption to the htmlCode variable
for (let i = 0; i < captions.length; i++) {
  htmlCode += "<figure><img alt='' src='slide" + i + ".jpg' /><figcaption>" + captions[i] + "</figcaption></figure>"
}

// Display the images and captions in the gallery div
